...
<body class="bg-app-background text-text-primary font-sans antialiased">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.05">
                    <h3 class="text-xl font-semibold text-heading mb-4">On-Page SEO</h3>
                    <div class="space-y-2">
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.1">
                    <h3 class="text-xl font-semibold text-heading mb-4">Content Strategy & SEO Blogging</h3>
                    <div class="space-y-2">
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.15">
                    <h3 class="text-xl font-semibold text-heading mb-4">Local SEO</h3>
                    <div class="space-y-2">
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.2">
                    <h3 class="text-xl font-semibold text-heading mb-4">Link Building & Authority</h3>
                    <div class="space-y-2">
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.25">
                    <h3 class="text-xl font-semibold text-heading mb-4">Digital Marketing & Paid Growth</h3>
                    <div class="space-y-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div class="space-y-8">
                    ...
                    <div class="process-step" data-animate="fade-up" data-delay="0.05">
                        ...
                        <h3 class="text-xl font-semibold text-heading mb-2">Strategy & Roadmap</h3>
                        <p class="text-heading/75 text-sm md:text-base">
                ...
                <div class="space-y-8">
                    <div class="process-step" data-animate="fade-up" data-delay="0.1">
                        ...
                        <h3 class="text-xl font-semibold text-heading mb-2">Execution & Optimization</h3>
                        <p class="text-heading/75 text-sm md:text-base">
                    ...
                    <div class="process-step" data-animate="fade-up" data-delay="0.15">
                        ...
                        <h3 class="text-xl font-semibold text-heading mb-2">Tracking, Reporting & Scaling</h3>
                        <p class="text-heading/75 text-sm md:text-base">
    ...
    <section class="py-16 px-4 sm:px-6 lg:px-8 bg-app-background">
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
            <div data-animate="fade-up">
                <h2 class="text-2xl md:text-3xl font-heading font-semibold text-heading mb-4">
    ...
    <section class="py-16 px-4 sm:px-6 lg:px-8 bg-surface-1">
        <div class="max-w-4xl mx-auto">
            ...
            <div data-animate="fade-up" data-delay="0.05">
                ...
                <div class="faq-item">
                    <h3 class="text-lg font-semibold text-heading mb-2">Is SEO and digital marketing suitable for startups?</h3>
                    <p class="text-heading/80 text-sm md:text-base">
                ...
                <div class="faq-item">
                    <h3 class="text-lg font-semibold text-heading mb-2">Can you work with our existing marketing team?</h3>
                    <p class="text-heading/80 text-sm md:text-base">
