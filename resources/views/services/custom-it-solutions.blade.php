...
<body class="bg-app-background text-text-primary font-sans antialiased">
    ...
    <section class="relative overflow-hidden pt-32 pb-20 px-4 sm:px-6 lg:px-8 min-h-[500px] md:min-h-[600px] flex items-center">
        ...
        <div class="absolute inset-0 w-full h-full">
            <img 
                src="{{ asset('images/banner images/IT Solutions.jpg') }}" 
                alt="Custom IT Solutions Services - Techbuds" 
        ...
        <div class="relative max-w-7xl mx-auto w-full z-10">
            <div data-animate="fade-up">
                <span class="service-pill bg-brand-primary/20 border-brand-primary/30 backdrop-blur-sm text-white">Custom IT Solutions</span>
            </div>
            <h1 class="mt-6 text-4xl md:text-5xl lg:text-6xl font-heading font-semibold text-white leading-tight drop-shadow-lg" data-animate="fade-up" data-delay="0.1">
                Tailor-Made Software <span class="text-gradient bg-gradient-to-r from-white via-blue-100 to-blue-300 bg-clip-text text-transparent">Built Around Your Business Needs</span>
            </h1>
            <p class="mt-6 text-lg md:text-xl text-white/90 max-w-3xl leading-relaxed drop-shadow-md" data-animate="fade-up" data-delay="0.2">
                Every business operates differently — your software should too. At <strong class="text-white">Techbuds</strong>, we deliver custom IT solutions designed specifically for your workflows, challenges, and growth goals. No templates. No unnecessary features. Only systems that solve real problems.
            </p>
