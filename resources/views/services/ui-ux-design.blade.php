...
<body class="bg-[#FFFDF6] text-gray-900 antialiased">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="service-card" data-animate="fade-up">
                    <h3 class="text-xl font-semibold text-[#11224E] mb-4">Strong design directly impacts:</h3>
                    <div class="space-y-2">
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.1">
                    <h3 class="text-xl font-semibold text-[#11224E] mb-4">Poor design often leads to:</h3>
                    <div class="space-y-2">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="service-card" data-animate="fade-up">
                    ...
                    <h3 class="text-xl font-semibold text-[#11224E] mb-3">UI Design (User Interface)</h3>
                    <p class="text-sm text-[#11224E]/70 mb-3">Visually appealing, modern interfaces that align with your brand.</p>
                    <div class="space-y-2">
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.1">
                    <div class="service-icon text-2xl mb-4">🧭</div>
                    <h3 class="text-xl font-semibold text-[#11224E] mb-3">UX Design (User Experience)</h3>
                    <p class="text-sm text-[#11224E]/70 mb-3">Design that guides users effortlessly through your product.</p>
                    <div class="space-y-2">
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.2">
                    <div class="service-icon text-2xl mb-4">💎</div>
                    <h3 class="text-xl font-semibold text-[#11224E] mb-3">Branding & Visual Identity</h3>
                    <p class="text-sm text-[#11224E]/70 mb-3">Build a brand that users recognize, remember, and trust.</p>
                    <div class="space-y-2">
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.3">
                    <div class="service-icon text-2xl mb-4">📱</div>
                    <h3 class="text-xl font-semibold text-[#11224E] mb-3">Web & Mobile App Design</h3>
                    <p class="text-sm text-[#11224E]/70 mb-3">Designs optimized for real-world usage and business outcomes.</p>
                    <div class="space-y-2">
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.4">
                    ...
                    <h3 class="text-xl font-semibold text-[#11224E] mb-3">Design Optimization & Redesign</h3>
                    <p class="text-sm text-[#11224E]/70 mb-3">Improve existing products for better performance and engagement.</p>
                    <div class="space-y-2">
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="space-y-6">
                <div class="process-step" data-animate="fade-up">
                    ...
                    <h3 class="text-xl font-semibold text-[#11224E] mb-2">Research & Discovery</h3>
                    <p class="text-base text-[#11224E]/70 leading-relaxed">Understanding users, business goals, and brand direction.</p>
                </div>

                <div class="process-step" data-animate="fade-up" data-delay="0.1">
                    <div class="process-number">2</div>
                    <h3 class="text-xl font-semibold text-[#11224E] mb-2">Strategy & Planning</h3>
                    <p class="text-base text-[#11224E]/70 leading-relaxed">User flows, information architecture, and a clear design roadmap.</p>
                </div>

                <div class="process-step" data-animate="fade-up" data-delay="0.2">
                    <div class="process-number">3</div>
                    <h3 class="text-xl font-semibold text-[#11224E] mb-2">Design & Prototyping</h3>
                    <p class="text-base text-[#11224E]/70 leading-relaxed">Wireframes, high-fidelity designs, and interactive prototypes.</p>
                </div>

                <div class="process-step" data-animate="fade-up" data-delay="0.3">
                    <div class="process-number">4</div>
                    <h3 class="text-xl font-semibold text-[#11224E] mb-2">Testing & Delivery</h3>
                    <p class="text-base text-[#11224E]/70 leading-relaxed">Usability testing, feedback loops, and final handoff to development.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="service-card" data-animate="fade-up">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-[#11224E] mb-2">User-first, business-driven design</h3>
                            <p class="text-sm text-[#11224E]/70 leading-relaxed">Every design decision is based on user behavior and business outcomes.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.1">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-[#11224E] mb-2">Modern, clean, and scalable design systems</h3>
                            <p class="text-sm text-[#11224E]/70 leading-relaxed">We build reusable components and design systems that scale with your product.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.2">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-[#11224E] mb-2">Strong collaboration with development teams</h3>
                            <p class="text-sm text-[#11224E]/70 leading-relaxed">Developer-ready designs, assets, and documentation for smooth handoff.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.3">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-[#11224E] mb-2">Conversion-focused layouts</h3>
                            <p class="text-sm text-[#11224E]/70 leading-relaxed">We design flows and screens that guide users toward action.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.4">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-[#11224E] mb-2">Consistent branding across touchpoints</h3>
                            <p class="text-sm text-[#11224E]/70 leading-relaxed">From website to product UI, your brand feels unified everywhere.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.5">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-[#11224E] mb-2">Experiences that convert</h3>
                            <p class="text-sm text-[#11224E]/70 leading-relaxed">We design not just screens — we design experiences that convert.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                ...
                <div class="text-center" data-animate="fade-up" data-delay="0.1">
                    <div class="service-icon text-2xl mx-auto mb-3">🛒</div>
                    <h3 class="text-lg font-semibold text-[#11224E]">E-commerce platforms</h3>
                </div>
                ...
                <div class="text-center" data-animate="fade-up" data-delay="0.3">
                    <div class="service-icon text-2xl mx-auto mb-3">🏢</div>
                    <h3 class="text-lg font-semibold text-[#11224E]">Enterprise applications</h3>
                </div>
                <div class="text-center" data-animate="fade-up" data-delay="0.4">
                    <div class="service-icon text-2xl mx-auto mb-3">📌</div>
                    <h3 class="text-lg font-semibold text-[#11224E]">Digital agencies</h3>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFDF6]">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                <div class="text-center" data-animate="fade-up">
                    <h3 class="text-base font-semibold text-[#11224E]">Figma</h3>
                </div>
                <div class="text-center" data-animate="fade-up" data-delay="0.1">
                    <h3 class="text-base font-semibold text-[#11224E]">Adobe XD</h3>
                </div>
                <div class="text-center" data-animate="fade-up" data-delay="0.2">
                    <h3 class="text-base font-semibold text-[#11224E]">Design systems & libraries</h3>
                </div>
                <div class="text-center" data-animate="fade-up" data-delay="0.3">
                    <h3 class="text-base font-semibold text-[#11224E]">Prototyping tools</h3>
                </div>
                <div class="text-center" data-animate="fade-up" data-delay="0.4">
                    <h3 class="text-base font-semibold text-[#11224E]">UX research & testing tools</h3>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="space-y-4">
                <div class="faq-item" data-animate="fade-up">
                    <h3 class="text-lg font-semibold text-[#11224E] mb-2">What is the difference between UI and UX?</h3>
                    <p class="text-sm text-[#11224E]/70 leading-relaxed">UI focuses on <strong>visual design</strong> — colors, typography, and layout — while UX focuses on <strong>user experience and usability</strong>. Both work together to create a product users love.</p>
                </div>

                <div class="faq-item" data-animate="fade-up" data-delay="0.1">
                    <h3 class="text-lg font-semibold text-[#11224E] mb-2">Do you redesign existing products?</h3>
                    <p class="text-sm text-[#11224E]/70 leading-relaxed">Yes. We perform UX audits, modernize UI, and improve flows to increase usability, engagement, and conversions.</p>
                </div>

                <div class="faq-item" data-animate="fade-up" data-delay="0.2">
                    <h3 class="text-lg font-semibold text-[#11224E] mb-2">Will designs be developer-ready?</h3>
                    <p class="text-sm text-[#11224E]/70 leading-relaxed">Absolutely. We provide clean Figma files, components, specs, and exportable assets so development teams can implement quickly.</p>
                </div>

                <div class="faq-item" data-animate="fade-up" data-delay="0.3">
                    <h3 class="text-lg font-semibold text-[#11224E] mb-2">Is branding included with UI/UX?</h3>
                    <p class="text-sm text-[#11224E]/70 leading-relaxed">Yes. We offer complete branding and visual identity solutions alongside product UI/UX design.</p>
                </div>
            </div>
        </div>
    </section>
