        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="service-card" data-animate="fade-up">
                    <h3 class="text-xl font-semibold text-[#11224E] mb-4">A slow, poorly structured website costs you:</h3>
                    <div class="space-y-2">
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.1">
                    <h3 class="text-xl font-semibold text-[#11224E] mb-4">Our web development services ensure:</h3>
                    <div class="space-y-2">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="service-card" data-animate="fade-up">
                    ...
                    <h3 class="text-xl font-semibold text-[#11224E] mb-3">Custom Website Development</h3>
                    <p class="text-sm text-[#11224E]/70 mb-3">We build fully custom websites tailored to your business goals — not templates.</p>
                    <div class="space-y-2">
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.1">
                    <div class="service-icon text-2xl mb-4">⚡</div>
                    <h3 class="text-xl font-semibold text-[#11224E] mb-3">Full-Stack Web Applications</h3>
                    <p class="text-sm text-[#11224E]/70 mb-3">Robust web applications engineered for performance and scalability using any modern stack.</p>
                    <div class="space-y-2">
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.2">
                    <div class="service-icon text-2xl mb-4">🚀</div>
                    <h3 class="text-xl font-semibold text-[#11224E] mb-3">Performance & SEO-Optimized Development</h3>
                    <p class="text-sm text-[#11224E]/70 mb-3">Every website we build follows SEO and performance best practices from day one.</p>
                    <div class="space-y-2">
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.3">
                    <div class="service-icon text-2xl mb-4">📊</div>
                    <h3 class="text-xl font-semibold text-[#11224E] mb-3">CMS & Custom Dashboards</h3>
                    <p class="text-sm text-[#11224E]/70 mb-3">We develop easy-to-manage systems that give you full control.</p>
                    <div class="space-y-2">
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.4">
                    <div class="service-icon text-2xl mb-4">🔄</div>
                    <h3 class="text-xl font-semibold text-[#11224E] mb-3">Website Redesign & Optimization</h3>
                    <p class="text-sm text-[#11224E]/70 mb-3">Already have a website? We improve it.</p>
                    <div class="space-y-2">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="service-card text-center" data-animate="fade-up">
                    ...
                    <p class="text-sm text-[#11224E]/70">React, Vue, Angular, Next.js, HTML, Tailwind CSS, JavaScript, TypeScript</p>
                </div>
                <div class="service-card text-center" data-animate="fade-up" data-delay="0.1">
                    ...
                    <p class="text-sm text-[#11224E]/70">Node.js, Express, Laravel, PHP, Python, Django, FastAPI, .NET</p>
                </div>
                <div class="service-card text-center" data-animate="fade-up" data-delay="0.2">
                    ...
                    <p class="text-sm text-[#11224E]/70">MySQL, PostgreSQL, MongoDB, Firebase, Redis, DynamoDB</p>
                </div>
                <div class="service-card text-center" data-animate="fade-up" data-delay="0.3">
                    <h3 class="text-lg font-semibold text-[#11224E] mb-2">Full-Stack</h3>
                    <p class="text-sm text-[#11224E]/70">MERN Stack, MEAN Stack, LAMP Stack, Serverless, Microservices</p>
                </div>
                <div class="service-card text-center" data-animate="fade-up" data-delay="0.4">
                    <h3 class="text-lg font-semibold text-[#11224E] mb-2">Cloud & DevOps</h3>
                    <p class="text-sm text-[#11224E]/70">AWS, GCP, Azure, Firebase, Vercel, Docker, Kubernetes, CI/CD</p>
                </div>
                <div class="service-card text-center" data-animate="fade-up" data-delay="0.5">
                    <h3 class="text-lg font-semibold text-[#11224E] mb-2">APIs & Integrations</h3>
                    <p class="text-sm text-[#11224E]/70">RESTful APIs, GraphQL, WebSockets, Third-party integrations</p>
                </div>
                <div class="service-card text-center" data-animate="fade-up" data-delay="0.6">
                    <h3 class="text-lg font-semibold text-[#11224E] mb-2">Mobile Web</h3>
                    <p class="text-sm text-[#11224E]/70">PWA, Responsive Design, Mobile-first Development</p>
                </div>
                <div class="service-card text-center" data-animate="fade-up" data-delay="0.7">
                    <h3 class="text-lg font-semibold text-[#11224E] mb-2">Real-time & Services</h3>
                    <p class="text-sm text-[#11224E]/70">WebSockets, Firebase Realtime, Server-Sent Events, Microservices</p>
                </div>
            </div>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="space-y-6">
                <div class="process-step" data-animate="fade-up">
                    ...
                    <h3 class="text-xl font-semibold text-[#11224E] mb-2">Discovery & Requirement Analysis</h3>
                    <p class="text-base text-[#11224E]/70 leading-relaxed">We understand your business, goals, users, and technical needs.</p>
                </div>

                <div class="process-step" data-animate="fade-up" data-delay="0.1">
                    <div class="process-number">2</div>
                    <h3 class="text-xl font-semibold text-[#11224E] mb-2">Planning & Architecture</h3>
                    <p class="text-base text-[#11224E]/70 leading-relaxed">We define site structure, tech stack, SEO strategy, and timelines.</p>
                </div>

                <div class="process-step" data-animate="fade-up" data-delay="0.2">
                    <div class="process-number">3</div>
                    <h3 class="text-xl font-semibold text-[#11224E] mb-2">Design & Development</h3>
                    <p class="text-base text-[#11224E]/70 leading-relaxed">Clean UI, robust backend, optimized performance, and testing.</p>
                </div>
                ...
                <div class="process-step" data-animate="fade-up" data-delay="0.3">
                    ...
                    <p class="text-base text-[#11224E]/70 leading-relaxed">Deployment, monitoring, maintenance, and future scalability support.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="service-card" data-animate="fade-up">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-[#11224E] mb-2">Modern, clean & scalable codebase</h3>
                            <p class="text-sm text-[#11224E]/70 leading-relaxed">We write maintainable code that grows with your business.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.1">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-[#11224E] mb-2">SEO-first development approach</h3>
                            <p class="text-sm text-[#11224E]/70 leading-relaxed">Every website is built with SEO best practices from the start.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.2">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-[#11224E] mb-2">Performance-optimized websites</h3>
                            <p class="text-sm text-[#11224E]/70 leading-relaxed">Fast load times and smooth user experiences.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.3">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-[#11224E]/70 leading-relaxed">You'll always know what's happening and why.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.4">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-[#11224E]/70 leading-relaxed">We're here for maintenance, updates, and scaling.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="service-card" data-animate="fade-up" data-delay="0.5">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-[#11224E] mb-2">Business-focused solutions</h3>
                            <p class="text-sm text-[#11224E]/70 leading-relaxed">Not just code — we build digital foundations for growth.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                ...
                <div class="text-center" data-animate="fade-up" data-delay="0.1">
                    <div class="service-icon text-2xl mx-auto mb-3">🏢</div>
                    <h3 class="text-lg font-semibold text-[#11224E]">Small & medium businesses</h3>
                </div>
                ...
                <div class="text-center" data-animate="fade-up" data-delay="0.4">
                    <div class="service-icon text-2xl mx-auto mb-3">👥</div>
                    <h3 class="text-lg font-semibold text-[#11224E]">Growing tech teams</h3>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="space-y-4">
                <div class="faq-item" data-animate="fade-up">
                    <h3 class="text-lg font-semibold text-[#11224E] mb-2">How long does web development take?</h3>
                    <p class="text-sm text-[#11224E]/70 leading-relaxed">Project timelines vary, but most websites take <strong>2–6 weeks</strong> depending on complexity.</p>
                </div>

                <div class="faq-item" data-animate="fade-up" data-delay="0.1">
                    <h3 class="text-lg font-semibold text-[#11224E] mb-2">Do you build SEO-ready websites?</h3>
                    <p class="text-sm text-[#11224E]/70 leading-relaxed">Yes. Every website is built with <strong>technical SEO, performance, and clean structure</strong>.</p>
                </div>

                <div class="faq-item" data-animate="fade-up" data-delay="0.2">
                    <h3 class="text-lg font-semibold text-[#11224E] mb-2">Can you work with existing websites?</h3>
                    <p class="text-sm text-[#11224E]/70 leading-relaxed">Absolutely. We handle redesigns, optimizations, and feature upgrades.</p>
                </div>

                <div class="faq-item" data-animate="fade-up" data-delay="0.3">
                    <h3 class="text-lg font-semibold text-[#11224E] mb-2">Do you provide maintenance?</h3>
                    <p class="text-sm text-[#11224E]/70 leading-relaxed">Yes. We offer ongoing support, updates, and performance monitoring.</p>
                </div>
            </div>
        </div>
    </section>
