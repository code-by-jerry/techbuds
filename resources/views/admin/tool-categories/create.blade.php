...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-[#11224E]">Create New Category</h2>
            <p class="text-sm text-[#088395]/70 mt-1">Add a new devtools category</p>
        </div>
    ...
    <!-- Form -->
    <form action="{{ route('admin.tool-categories.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="rounded-2xl border border-[#088395]/10 bg-white p-6 shadow-sm">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    />
                    <p class="mt-1 text-xs text-[#088395]/70">Leave empty to auto-generate from name</p>
                    @error('slug')
                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                    @enderror
                </div>
        ...
        <div class="flex items-center justify-end gap-3">
            <a href="{{ route('admin.tool-categories.index') }}" class="rounded-lg border border-[#088395]/20 px-4 py-2 text-sm font-medium text-[#088395] transition-colors hover:bg-[#088395]/5">
                Cancel
            </a>
