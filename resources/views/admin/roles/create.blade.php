...
<div class="space-y-6">
    <!-- Header -->
    <div>
        <h2 class="text-2xl font-bold text-heading">Create New Role</h2>
        <p class="text-sm text-text-secondary mt-1">Define a custom role with specific permissions</p>
    </div>
        ...
        <form method="POST" action="{{ route('admin.roles.store') }}" class="space-y-6">
            ...
            <div>
                ...
                <input
                    ...
                    value="{{ old('name') }}"
                    required
                    placeholder="e.g., Content Manager, Editor, etc."
