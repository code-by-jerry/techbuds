...
<div class="space-y-6">
    <!-- Header -->
    <div>
        <h2 class="text-2xl font-bold text-[#11224E]">Create New Admin</h2>
        <p class="text-sm text-[#088395]/70 mt-1">Add a new admin user to the system</p>
    </div>
    ...
    <div class="rounded-xl border border-[#088395]/20 bg-white p-6 shadow-sm">
        <form method="POST" action="{{ route('admin.admins.store') }}" class="space-y-4">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div>
                    <label for="password" class="block text-sm font-medium text-[#11224E] mb-2">Password</label>
                    <input
                        type="password"
                        id="password"
                        name="password"
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-[#11224E] mb-2">Confirm Password</label>
                    <input
                        type="password"
