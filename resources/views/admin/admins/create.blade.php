...
<div class="space-y-6">
    <!-- Header -->
    <div>
        <h2 class="text-2xl font-bold text-heading">Create New Admin</h2>
        <p class="text-sm text-text-secondary mt-1">Add a new admin user to the system</p>
    </div>
    ...
    <div class="rounded-xl border border-border-default bg-surface-1 p-6 shadow-sm">
        <form method="POST" action="{{ route('admin.admins.store') }}" class="space-y-4">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div>
                    <label for="password" class="block text-sm font-medium text-heading mb-2">Password</label>
                    <input
                        type="password"
                        id="password"
                        name="password"
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-heading mb-2">Confirm Password</label>
                    <input
                        type="password"
...
// Show permissions if role is pre-selected (from old input)
