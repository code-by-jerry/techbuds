    ...
    <div class="flex items-center justify-between">
        <div>
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-2xl font-bold text-heading">Edit Payment</h2>
            </div>
            <p class="text-sm text-brand-primary/70 mt-1">Update payment for invoice {{ $invoice->invoice_number }}</p>
        </div>
    </div>
        ...
        <div class="rounded-2xl border border-border-default bg-surface-1 p-6 shadow-sm">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <div class="mb-2 rounded-lg border border-border-default bg-brand-primary/5 p-3">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm text-heading">Current receipt uploaded</span>
                            </div>
                            <a href="{{ route('admin.invoice-payments.download-receipt', $payment) }}" class="text-xs text-brand-primary hover:text-[var(--brand-soft)]">
                                Download
                            </a>
                        </div>
                    </div>
